...
public class EarlyAdultPhenotypingAbortReverserProcessor implements Processor {
    private StatusService statusService;

    public EarlyAdultPhenotypingAbortReverserProcessor(StatusService statusService)
    {
