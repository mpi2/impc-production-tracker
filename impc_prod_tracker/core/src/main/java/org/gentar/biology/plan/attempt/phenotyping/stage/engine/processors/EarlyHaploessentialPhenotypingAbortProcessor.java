...
public class EarlyHaploessentialPhenotypingAbortProcessor implements Processor {
    private StatusService statusService;

    public EarlyHaploessentialPhenotypingAbortProcessor(StatusService statusService) {
