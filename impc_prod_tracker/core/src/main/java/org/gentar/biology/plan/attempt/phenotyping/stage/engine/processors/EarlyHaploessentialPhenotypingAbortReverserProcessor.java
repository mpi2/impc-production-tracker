...
public class EarlyHaploessentialPhenotypingAbortReverserProcessor implements Processor {
    private StatusService statusService;

    public EarlyHaploessentialPhenotypingAbortReverserProcessor(StatusService statusService)
    {
