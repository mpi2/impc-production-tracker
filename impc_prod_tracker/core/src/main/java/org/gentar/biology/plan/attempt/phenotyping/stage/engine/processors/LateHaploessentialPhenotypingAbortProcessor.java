...
public class LateHaploessentialPhenotypingAbortProcessor implements Processor {
    private StatusService statusService;

    public LateHaploessentialPhenotypingAbortProcessor(StatusService statusService) {
