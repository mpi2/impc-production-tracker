...
public class LateHaploessentialPhenotypingAbortReverserProcessor implements Processor {
    private StatusService statusService;

    public LateHaploessentialPhenotypingAbortReverserProcessor(StatusService statusService)
    {
