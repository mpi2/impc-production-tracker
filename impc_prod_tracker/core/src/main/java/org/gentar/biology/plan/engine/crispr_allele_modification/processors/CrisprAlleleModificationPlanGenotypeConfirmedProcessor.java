...
@Component
public class CrisprAlleleModificationPlanGenotypeConfirmedProcessor extends AbstractProcessor {

    public CrisprAlleleModificationPlanGenotypeConfirmedProcessor(PlanStateSetter planStateSetter)
    {
