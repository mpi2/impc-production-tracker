...
public class TargRepIkmcProjectServiceImpl implements TargRepIkmcProjectService {
    ...
    public TargRepIkmcProjectServiceImpl(
        TargRepIkmcProjectRepository targRepIkmcProjectRepository) {
    ...
    public TargRepIkmcProject getNotNullTargRepIkmcProjectById(Long id) throws NotFoundException {
        TargRepIkmcProject targRepIkmcProject =
            targRepIkmcProjectRepository.findTargRepIkmcProjectById(id);
