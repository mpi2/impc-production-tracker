...
public class TargRepIkmcProjectStatusServiceImpl implements TargRepIkmcProjectStatusService {
    ...
    public TargRepIkmcProjectStatusServiceImpl(TargRepIkmcProjectStatusRepository targRepIkmcProjectStatusRepository) {
    ...
    {
        return targRepIkmcProjectStatusRepository.findTargRepIkmcProjectStatusByNameIgnoreCase(name);
    }
}
