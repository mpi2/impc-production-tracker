...
public interface PhenotypingColonyReportPhenotypingAttemptRepository extends CrudRepository<PhenotypingAttempt, Long> {
    ...
    @Query("select " +
            ...
            "having " +
            "count(psp.id)=1")
    List<PhenotypingColonyReportPhenotypingAttemptProjection> findAllPhenotypingAttemptProjections();
    ...
    @Query("select " +
            ...
            "having " +
            "count(psp.id)=1")
    List<PhenotypingColonyReportPhenotypingAttemptProjection> findPhenotypingAttemptProjectionsFromCrisprProduction();
    ...
    @Query("select " +
            ...
            "having " +
            "count(psp.id)=1")
    List<PhenotypingColonyReportPhenotypingAttemptProjection> findPhenotypingAttemptProjectionsFromEsCellProduction();
    ...
    @Query("select " +
            ...
            "having " +
            "count(psp.id)=1 ")
    List<PhenotypingColonyReportPhenotypingAttemptProjection> findPhenotypingAttemptProjectionsFromEsCellModificationProduction();
