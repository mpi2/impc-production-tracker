...
class PhenotypingStartedProcessorTest
{
    private PhenotypingStartedProcessor testInstance;
    ...
    void setUp()
    {
        testInstance = new PhenotypingStartedProcessor(stageStateSetter, policyEnforcement);
    }
