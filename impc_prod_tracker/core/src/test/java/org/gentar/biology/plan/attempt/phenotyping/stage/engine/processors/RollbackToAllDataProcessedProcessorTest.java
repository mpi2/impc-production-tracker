...
class RollbackToAllDataProcessedProcessorTest
{
    private RollbackToAllDataProcessedProcessor testInstance;
    ...
    void setUp()
    {
        testInstance = new RollbackToAllDataProcessedProcessor(stageStateSetter, policyEnforcement);
    }
