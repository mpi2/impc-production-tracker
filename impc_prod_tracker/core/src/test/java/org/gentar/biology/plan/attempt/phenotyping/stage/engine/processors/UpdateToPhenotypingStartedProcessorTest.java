...
class UpdateToPhenotypingStartedProcessorTest
{
    private UpdateToPhenotypingStartedProcessor testInstance;
    ...
    void setUp()
    {
        testInstance = new UpdateToPhenotypingStartedProcessor(stageStateSetter, policyEnforcement);
    }
    ...
    private void assertTransitionCannotBeExecuted(UserOperationFailedException thrown)
    {
        ...
        assertThat(
            ...
            is("The current user does not have permission to rollback to 'Phenotyping Started'"));
        verify(
