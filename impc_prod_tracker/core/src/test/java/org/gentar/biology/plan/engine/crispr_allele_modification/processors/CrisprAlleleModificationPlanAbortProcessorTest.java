...
class CrisprAlleleModificationPlanAbortProcessorTest {
    private CrisprAlleleModificationPlanAbortProcessor testInstance;
    ...
    @BeforeEach
    void setUp() {
        testInstance = new CrisprAlleleModificationPlanAbortProcessor(planStateSetter);
    }
