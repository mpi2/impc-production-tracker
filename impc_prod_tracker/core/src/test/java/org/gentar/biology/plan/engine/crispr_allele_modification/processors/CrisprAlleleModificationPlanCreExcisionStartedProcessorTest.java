...
class CrisprAlleleModificationPlanCreExcisionStartedProcessorTest {

    private CrisprAlleleModificationPlanCreExcisionStartedProcessor testInstance;
    ...
    void setUp()
    {
        testInstance = new CrisprAlleleModificationPlanCreExcisionStartedProcessor(planStateSetter);
    }
