...
class CrisprAlleleModificationPlanRevertToCreExcisionCompleteProcessorTest {

    private CrisprAlleleModificationPlanRevertToCreExcisionCompleteProcessor testInstance;
    ...
    void setUp()
    {
        testInstance = new CrisprAlleleModificationPlanRevertToCreExcisionCompleteProcessor(planStateSetter);
    }
