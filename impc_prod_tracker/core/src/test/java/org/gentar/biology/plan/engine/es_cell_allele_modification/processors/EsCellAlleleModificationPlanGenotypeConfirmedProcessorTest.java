...
class EsCellAlleleModificationPlanGenotypeConfirmedProcessorTest {

    private EsCellAlleleModificationPlanGenotypeConfirmedProcessor testInstance;
    ...
    void setUp()
    {
        testInstance = new EsCellAlleleModificationPlanGenotypeConfirmedProcessor(planStateSetter);
    }
