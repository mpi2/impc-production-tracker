...
This endpoint shows specific TargRep ES Cell s cell by name the user has permission to see.

===== Example Request

Curl:
include::{snippets}/targrep/esCell/EsCellByName/curl-request.adoc[]

===== Example Response

include::{snippets}/targrep/esCell/EsCellByName/http-response.adoc[]
...
* 2026-02-09: The 'strainName' field have been added to Targ Rep EsCell.
