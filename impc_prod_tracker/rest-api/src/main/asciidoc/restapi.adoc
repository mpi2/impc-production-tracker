...
This endpoint shows a production plan in the system.
...
Curl:
ADD PHENOTYPING PLAN INFORMATION
...
NO INFORMATION IN THE PHENOTYPING PLAN CAN BE UPDATE, JUST THE PLAN
===== Example Request
...
include::{snippets}/phenotypingStage/response-fields.adoc[]
...
Curl:
include::{snippets}/phenotypingStage/curl-request.adoc[]

===== Example Response

include::{snippets}/phenotypingStage/http-response.adoc[]
...
Curl:
include::{snippets}/phenotypingStage/history/curl-request.adoc[]

===== Example Response

include::{snippets}/phenotypingStage/history/http-response.adoc[]
...
Curl:
[TODO:LINK]
//include::{snippets}/phenotypingStage/postPhenotypingStage/http-request.adoc[]

===== Example Response
[TODO:LINK]
//include::{snippets}/phenotypingStage/postPhenotypingStage/http-response.adoc[]
...
Curl:
[TODO:LINK]
//include::{snippets}/phenotypingStage/putPhenotypingStage/http-request.adoc[]

===== Example Response
[TODO:LINK]
include::{snippets}/phenotypingStage/putPhenotypingStage/http-response.adoc[]
...
Several entities in GenTaR rely in a state machine to control the logic to change from a status
to another.

When you do a GET to one of those entities, you'll get as part of the response a *statusTransition*
section, which contains information about the current status and what actions cab be executed in order
