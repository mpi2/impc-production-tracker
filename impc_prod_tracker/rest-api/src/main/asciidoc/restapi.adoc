...
==== Cre Allele Modification plan.
include::{snippets}/plans/getCreAlleleModificationPlan/response-fields.adoc[]
...
* 2021-06-25: - Added the field esCellQcOnly to the Project entity to support projects that only relate to ES Cell QC.
              ...
              - GET requests for ES cell and Cre allele modification production plans are
