...
The filters you can use are listed above under the section <<Filters for projects>>.
...
In order to create a project, it is necessary to create at least one plan that is attached to it.
