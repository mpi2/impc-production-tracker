...
@Component
public class TargRepMutationSubtypeMapper implements Mapper<TargRepMutationSubtype, TargRepMutationSubtypeDTO> {
    ...
    public TargRepMutationSubtypeMapper(TargRepMutationSubtypeService targRepMutationSubtypeService) {
    ...
    public TargRepMutationSubtype toEntity(TargRepMutationSubtypeDTO dto)
    {
        ...
        {
            throw new UserOperationFailedException(String.format(TARG_REP_MUTATION_SUBTYPE_NOT_FOUND_ERROR, name));
        }
